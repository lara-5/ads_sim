...
5. **Ad Scheduling:**
    ...
    - The generated schedule is stored in the `ads_entering_schedule` dictionary in `world/simulation_state.py`.
...
6. **State Management:** The `world/simulation_state.py` file stores the global state of the simulation, including the current day and the ad entry schedule. This file is updated by the simulator.
