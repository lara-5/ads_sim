...
agents/
├── agent.ipynb                      ← Agent class implementation
└── memory_manager.ipynb             ← agent cache and memory management

world/
├── simulator.ipynb                  ← orchestration of simulation iterations and ad allocation
└── logger.ipynb                     ← logging all events and interactions to database

models/
└── decision_model.ipynb             ← machine learning model for behavior prediction

main.ipynb                           ← application entry point (starts simulation)
```
